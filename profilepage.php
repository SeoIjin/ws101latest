...
// Get join date (you may need to add a created_at column to your account table)
...
<head>
    ...
    <title>Profile - Barangay 170-E</title>
                ...
                <div class="footer-section">
                    ...
                    <div class="footer-content">
                        <div class="hospital-item">
                            ...
                            <div class="hospital-phone">2-7004-2881</div>
                        </div>
                        <div class="hospital-item">
